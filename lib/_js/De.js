...
// jQuery 
deIncludeJS('_js/jQuery1.6.1.min.js');	// ----------------------------------------- jquery 
...
deIncludeJS('deSlideList/deSlideList.js'); // ---------------------------------------- пролистывание слайдов
deIncludeJS('deShowPhoto/deShowPhoto.js'); // ---------------------------------------- пролистывание слайдов
deIncludeJS('deGetClaim/deGetClaim.js'); // ------------------------------------------ пролистывание слайдов
