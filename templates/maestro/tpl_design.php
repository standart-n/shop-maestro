...
function toolbar($q) { $s="";
	...
	$s.=	$this->toolbarLine($q,"company","О компании","disable",true);
	$s.=	$this->toolbarLine($q,"contacts","Контакты","disable",true);
	$s.=	$this->toolbarLine($q,"stock","Акции","disable",true);
	$s.=	$this->toolbarLine($q,"service","Сервис и ремонт","disable",true);
	$s.=	$this->toolbarLine($q,"delivery","Оплата и дставка","disable",true);
	$s.=	$this->toolbarLine($q,"sale","Скидки","disable",true);
	$s.=	$this->toolbarLine($q,"output","Продукция","disable",true);
